...
// BUG FIX: Removed unused imports: "request", "response" from express, and "token" from morgan
...
memberController.updateMember = async (req: ExtendedRequest, res: Response) => {
  try {
    ...
    const input: MemberInput = req.body;
    // BUG FIX: regex /\\/ only replaces the first backslash. Changed to /\\/g to replace all
